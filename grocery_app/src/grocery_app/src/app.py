...
from api_client import (get_nutritional_info, process_text_image, generate_grocery_recommendation, 
...
# AI Recommendation Section
    ...
    with tab1:
        ...
        if st.button("🥗 Find Ingredients", key="find_ingredients_btn"):
            if dish_name:
                ingredients_list = generate_dish_ingredients_or_recipes(user_id, dish_name, mode="dish_to_ingredients")
