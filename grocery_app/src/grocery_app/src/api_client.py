...
# Alternative method of loading API
...
def get_gemini_response(file_obj, text_prompt="What is the name of this object? Give a short answer inside {}"):
    """Process an image file-like object and generate a text response using the Google API."""
...
def generate_dish_ingredients_or_recipes(user_id, dish_or_ingredients, mode="dish_to_ingredients"):
    ...
    # Check if candidates exist in response and return first candidate
